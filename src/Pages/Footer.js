...
const Footer = () => {
    ...
    return (
        <div className="footerback w-full h-auto mb-0">

            <div className="flex justify-center space-x-6 footer mt-16" >
            ...
            <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                <nav className="flex flex-wrap justify-center -mx-5 -my-2" style={{"marginTop":"100px"}} >
                    <div className="px-12 py-2">
                        <a href="#" style={{ "fontSize": "35px" }} className="text-base leading-6 text-white hover:text-gray-900">
                            Home
                        </a>
                    </div>
                    <div className="px-12 py-2">
                        <a href="#" style={{ "fontSize": "35px" }} className="text-base leading-6 text-gray-500 hover:text-gray-900">
                            About
                        </a>
                    </div>
                    <div className="px-12 py-2">
            ...
            <div className="bg-transparent border w-full h-auto" style={{ "borderRadius": "42px 42px 0px 0px","marginTop":"100pxx" }}>
                ...
                <div className="flex justify-center  mt-8 space-x-6 bg-white mx-auto " style={{ "height": "0.8px", "width": "30%" }}>

                </div>

                <p className="mt-8 mb-8 text-base leading-6 text-center text-white">
