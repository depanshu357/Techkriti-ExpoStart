...
const About = () => {
    ...
    return (
        <>
            <div className="aboutback w-full h-screen">
                ...
                >
                    ...
                    <div className="abouthead align-center " >
                        <span style={{ "fontFamily": "Nasalization", "fontSize": "36.22px" }} className="hed text-white mx-auto" >About</span>


                    </div>
                    <div className="w-auto text-white aboutboxcontent  flex">
                        <p className='poppara scrollit' style={{"line-height":"44px"}}>
