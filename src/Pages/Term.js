const Term = () =>{
    return(
        ...
        <div className=" absolute border border-1 bg-transparent" style={{ "width": "1113px", "height": "682px", "borderRadius": "42px", "marginTop": "183px", "marginLeft": "118px","backgroundColor":"rgba(67, 0, 36, 0.3)" }}>

            <div className=" " style={{ "width": "344px", "height": "80px", "marginTop": "40px", "marginLeft": "87px" }}>
                <span style={{ "fontFamily": "Nasalization", "fontSize": "36.22px" }} className="text-white mx-auto" >Terms & Condition</span>


            </div>
            <div className="w-auto text-white flex"style={{"marginTop":"21px ","padding":"10px","marginLeft":"80px","fontSize":"28px","marginRight":"99px"}}>
                <p>
